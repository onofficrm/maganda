...
$mg_form_title = ($w === 'u') ? '회원정보 수정' : '회원가입';
$mg_form_desc = ($w === 'u')
    ? '변경할 정보를 입력한 뒤 저장해 주세요. <span class="required-mark">*</span> 표시는 필수 항목입니다.'
    : '필수 항목을 입력하고 가입을 완료해 주세요. <span class="required-mark">*</span> 표시는 필수입니다.';

mg_auth_shell_open('Member', $mg_form_title, $mg_form_desc, 'mg-auth--wide');
?>
