...
mg_auth_shell_open(
    'Join',
    '회원가입',
    '약관에 동의하시면 마간다TV 회원가입을 진행할 수 있습니다.'
);
mg_auth_nav('register');

echo '<div class="mg-auth-note"><i class="fa fa-info-circle" aria-hidden="true"></i><span>회원가입약관 및 개인정보 수집·이용에 동의하셔야 가입이 가능합니다.</span></div>';
?>
...
<div class="register">
    ...
    <section id="fregister_term">
        ...
        <fieldset class="fregister_agree">
            ...
            <label for="agree11"><span></span> 회원가입약관에 동의합니다.</label>
        </fieldset>
    </section>
    ...
    <section id="fregister_private" class="fregister_terms">
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td>아이디, 이름, 비밀번호<?php echo ($config['cf_cert_use']) ? ', 생년월일, 휴대폰 번호(본인인증 시), CI' : ''; ?></td>
                    <td>회원 탈퇴 시까지</td>
                </tr>
                <tr>
                    <td>고객서비스 이용에 관한 통지, CS대응</td>
        ...
        <fieldset class="fregister_agree">
            ...
            <label for="agree21"><span></span> 개인정보 수집 및 이용에 동의합니다.</label>
        </fieldset>
    </section>
